/**
 * Низкоуровневый REST-слой Bitrix24 (общий для проекта).
 * Вызывается из BitrixService, BitrixMapsService, ReferenceSheetsService и др.
 *
 * Здесь намеренно собраны проверки URL и разбор ответа — меньше шансов
 * сломать запрос при вебхуке без завершающего «/» и проще отлаживать ошибки API.
 */
